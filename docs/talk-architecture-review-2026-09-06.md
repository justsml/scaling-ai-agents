...
This review covers the current canonical outlines, changed implementation contracts, execution-memory handout and new short talks in the sibling `dans-blog` checkout. The [source snapshot](talk-source-snapshot-2026-09-06.json) records the commit and exact working-tree hashes. It supersedes the earlier two reviews in this file. Source links require the sibling checkout; the examples do not.

- [Adaptive systems](../../dans-blog/artifacts/speaking-portfolio-expanded/outlines/adaptive-systems-40min.md) and [contracts](../../dans-blog/artifacts/speaking-portfolio-expanded/packets/adaptive-systems/contracts.md).
- [Dynamic scaling](../../dans-blog/artifacts/speaking-portfolio-expanded/outlines/dynamic-scaling-40min.md), [Barrel of Monkeys](../../dans-blog/artifacts/speaking-portfolio-expanded/shorts/barrel-of-monkeys.md), and [Council of Guards](../../dans-blog/artifacts/speaking-portfolio-expanded/shorts/council-of-guards.md).
- [Judgment](../../dans-blog/artifacts/speaking-portfolio-expanded/outlines/judgment-40min.md), [failure improvement](../../dans-blog/artifacts/speaking-portfolio-expanded/outlines/failure-improvement-40min.md), and [product engineering](../../dans-blog/artifacts/speaking-portfolio-expanded/outlines/product-engineering-40min.md).
- [Benchmarks](../../dans-blog/artifacts/speaking-portfolio-expanded/outlines/benchmarks-40min.md), [retrieval](../../dans-blog/artifacts/speaking-portfolio-expanded/outlines/retrieval-40min.md), [evidence learning](../../dans-blog/artifacts/speaking-portfolio-expanded/outlines/evidence-learning-40min.md), and [free-tier economics](../../dans-blog/artifacts/speaking-portfolio-expanded/outlines/free-tier-40min.md).
