...
Twelve standalone snippets cover the five axes, routing, remote work, batching, Pokédex investigations, bounded fan-out and the advice council. Start with `05` or `16` for an offline run.
