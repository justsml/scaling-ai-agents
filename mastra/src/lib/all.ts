...
const PLAN: SnippetPlan[] = [
  {
    ...
    budgetUsd: 0.02,
    deadlineMs: 45_000,
    note: "classify, contract, dispatch",
  },
  {
    id: "01-compete",
    ...
    budgetUsd: 0.06,
    deadlineMs: 120_000,
    note: "four stances, two judging passes",
  },
  {
    id: "02-decompose",
    ...
    budgetUsd: 0.04,
    deadlineMs: 120_000,
    note: "three evidence workers plus a reviewer",
  },
  {
    id: "03-constrain",
    ...
    budgetUsd: 0.05,
    deadlineMs: 60_000,
    note: "two passes, two honest stops",
  },
  {
    id: "04-distribute",
    ...
    budgetUsd: 0.03,
    deadlineMs: 120_000,
    note: "pool, residency, remote worker",
  },
  {
    id: "05-compile",
    ...
    budgetUsd: 0.03,
    deadlineMs: 120_000,
    note: "tournament once, then never again",
  },
  {
    id: "06-remote-a2a",
    file: "src/snippets/06-remote-a2a.ts",
    budgetUsd: 0.02,
    deadlineMs: 90_000,
    note: "agent card, stream, cancel",
  },
  {
    id: "07-batching",
    ...
    budgetUsd: 0.03,
    deadlineMs: 120_000,
    note: "tool calls, foreach, background",
  },
];
